    ...
    return (
        <div className="developer">
            <div className="text-center">
                <h1 className="mt-5 pt-4" style={{"font-family": "'Roboto Slab', serif",}}>Resume</h1>
                <hr className="hr1"/>
                ...
                <div className="row">
                    <div className="col-10 mx-auto">
                        ...
                        <div className="row my-4">
                            <div className="col-lg-6 col-md-12" data-aos="fade-down" data-aos-delay="500">
                                <h6><span className="left ms-2">HTML</span> <span className="right me-2">95%</span></h6>
                                <div className="progress">
                                    <div className="progress-bar" style={{width: "95%", background:"#51cdbe", color:"#000"}} ></div>
                                </div>
                                <h6><span className="left ms-2">CSS</span> <span className="right me-2">90%</span></h6>
                                <div className="progress">
                                    <div className="progress-bar" style={{width: "90%", background:"#51cdbe", color:"#000"}} ></div>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-12" data-aos="fade-down" data-aos-delay="500">
                                <h6><span className="left ms-2">Bootstrap</span> <span className="right me-2">90%</span></h6>
                                <div className="progress">
                                    <div className="progress-bar" style={{width: "90%", background:"#51cdbe", color:"#000"}}></div>
                                </div>
                                <h6><span className="left ms-2">ReactJs</span> <span className="right me-2">80%</span></h6>
                                <div className="progress">
                                    <div className="progress-bar" style={{width: "80%", background:"#51cdbe", color:"#000"}}></div>
                                </div>
                            </div>
                        </div> 
